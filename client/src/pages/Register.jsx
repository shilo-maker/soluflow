        ...
        <div className="register-card">
          {registrationSuccess ? (
            <div className="registration-success">
              ...
              <p>
                {t('register.successEmailSent')} <strong>{formData.email}</strong>
              </p>
              <p className="verification-note">{t('register.successNote')}</p>
              <button
              ...
              <div className="resend-info">
                <p>
                  {t('register.resendInfo')}{' '}
                  <Link to="/login">{t('register.resendLink')}</Link>{' '}
                  {t('register.resendInfoEnd')}
                </p>
              </div>
            </div>
          ) : (
