  ...
  io.on('connection', (socket) => {
    ...
    socket.on('join-service', ({ serviceId, userId, userRole, isLeader }) => {
      try {
        ...
        console.error(`[Socket Error] join-service failed:`, error);
    ...
    socket.on('leave-service', ({ serviceId }) => {
      try {
        ...
        console.error(`[Socket Error] leave-service failed:`, error);
      }
    });
    ...
    socket.on('leader-navigate', ({ serviceId, songId, songIndex, transposition }) => {
      try {
        ...
        console.error(`[Socket Error] leader-navigate failed:`, error);
      }
    });
    ...
    socket.on('leader-transpose', ({ serviceId, transposition, songId }) => {
      try {
        ...
        console.error(`[Socket Error] leader-transpose failed:`, error);
      }
    });
    ...
    socket.on('leader-toggle-lyrics', ({ serviceId, isLyricsOnly }) => {
      try {
        ...
        console.error(`[Socket Error] leader-toggle-lyrics failed:`, error);
      }
    });
    ...
    socket.on('leader-font-size', ({ serviceId, fontSize }) => {
      try {
        ...
        console.error(`[Socket Error] leader-font-size failed:`, error);
      }
    });
    ...
    socket.on('leader-changed', ({ serviceId, newLeaderId }) => {
      try {
        ...
        console.error(`[Socket Error] leader-changed failed:`, error);
      }
    });
    ...
    socket.on('disconnect', () => {
      try {
        ...
        console.error(`[Socket Error] disconnect handler failed:`, error);
      }
    });
  });
};
